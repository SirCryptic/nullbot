...
module.exports.run = (client, message, args, data, game, announcement, colors) => {
  ...
  if(commandlock.includes('true')) {       
    if(message.author.id !== data.ownerid) return message.channel.send('Sorry, but a command lock is in effect. Only the owner can use commands at this time, i may be having some updates.')   
  } 
  var setting = args[1]
